...
<template>
  <div class="app">
    <SidePanel :dragging="kanbanStore.dragging" />
    <main class="main-section">
      <div class="main-section__column-wraper">
        <KanbanColumn 
          @drop="kanbanStore.onDropColumn($event,column.id)" 
          :id="column.id" 
        ...
        >
          <RouterLink 
            ...
            @click="showTaskPanel" 
            draggable="true" 
            @dragend="kanbanStore.dragEnd()" 
            @dragstart="kanbanStore.startDrag($event,item.id,column.id)"
            :key="item.id"
          >
            <KanbanCard 
              :title="item.title" 
        ...
        <div 
          @click="kanbanStore.addNewColumn()" 
          class="main-section__add-column-button"
        >
          ДОБАВИТЬ
        </div>
      </div>
    </main>
    <ManagerPanel v-if="taskPanelStore.visible" />
  </div>
</template>
